...
// ConsentState and ConsentPurpose are canonical, registry-generated contracts.
// They are re-exported from @aether/shared (generated by
// scripts/generate_contracts.py from consent-registry.json) rather than
// declared here: this file previously carried a hand-written copy, which
// silently fell behind the registry when the fraud_prevention purpose was
// added and broke every consumer that mixed the two declarations.
