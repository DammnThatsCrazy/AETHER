// =============================================================================
// AETHER SDK — LENDING/BORROWING TRACKER
// AAVE V3, Compound V3, MakerDAO/Spark, Solend, Marginfi, Scallop, Morpho, Euler, Radiant, Venus, Benqi
// Events: supply, borrow, repay, withdraw, liquidation, flash_loan
// =============================================================================

import type { VMType, DeFiCategory } from '../../types';
import { identifyProtocol } from './protocol-registry';

export interface LendingTrackerCallbacks {
  onInteraction: (data: Record<string, unknown>) => void;
  onPositionChange: (data: Record<string, unknown>) => void;
}

export class LendingTracker {
  private callbacks: LendingTrackerCallbacks;
  private readonly category: DeFiCategory;

  constructor(callbacks: LendingTrackerCallbacks) {
    this.callbacks = callbacks;
    this.category = 'lending' as DeFiCategory;
  }
