// =============================================================================
// AETHER SDK — GOVERNANCE/DAO TRACKER
// Snapshot, Tally, Governor Bravo/Alpha, Realms (Solana), Aragon, Compound Governor
// Events: vote, propose, delegate, execute_proposal, queue_proposal
// =============================================================================

import type { VMType, DeFiCategory } from '../../types';
import { identifyProtocol } from './protocol-registry';

export interface GovernanceTrackerCallbacks {
...
export class GovernanceTracker {
  private callbacks: GovernanceTrackerCallbacks;
  private readonly category: DeFiCategory;

  constructor(callbacks: GovernanceTrackerCallbacks) {
    this.callbacks = callbacks;
    this.category = 'governance' as DeFiCategory;
  }
