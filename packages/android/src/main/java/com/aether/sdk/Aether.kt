...
object Aether : DefaultLifecycleObserver {
    ...
    private const val VERSION = "0.1.0-alpha.0"
...
// Contract version: 0.1.0-alpha.0 — Run: python scripts/generate_contracts.py
        ...
        "sdk_loaded" to "analytics",
        "sdk_initialized" to "analytics",
        "sdk_init_failed" to "analytics",
        "sdk_config_loaded" to "analytics",
        "sdk_config_failed" to "analytics",
        "sdk_batch_sent" to "analytics",
        "sdk_batch_accepted" to "analytics",
        "sdk_batch_rejected" to "analytics",
        "sdk_version_deprecated" to "analytics",
        "sdk_version_unsupported" to "analytics",
        "session_started" to "analytics",
        // journey
        ...
        "sdk_heartbeat_received" to "analytics",
        "sdk_heartbeat_failed" to "analytics",
        // identity_lc
