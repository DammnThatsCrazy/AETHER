...
export const EDGE_LAYER_MAP: Record<string, RelationshipLayer> = {
  ...
  // Derivatives Intelligence actor edges (parity: DERIVATIVES_ACTOR_EDGE_LAYER_MAP
  // in derivatives.ts and _EDGE_LAYER_MAP in relationship_layers.py)
  REFERRED_TO_VENUE: 'H2H',
  FUNDED: 'H2H',
  SHARES_TRADING_ACCOUNT_WITH: 'H2H',
  AUTHORIZED: 'H2H',
  COPIES_STRATEGY_FROM: 'H2H',
  PARTICIPATES_IN_VAULT_WITH: 'H2H',
  MEMBER_OF_TRADING_ORG_WITH: 'H2H',
  POSSIBLY_COORDINATED_WITH: 'H2H',
  POSSIBLY_MIRRORS: 'H2H',
  DELEGATES_TRADING_TO: 'H2A',
  AUTHORIZES_MARKETS_FOR: 'H2A',
  SETS_RISK_POLICY_FOR: 'H2A',
  APPROVES_TRADE_FROM: 'H2A',
  FUNDS_AGENT: 'H2A',
  OVERRIDES_AGENT: 'H2A',
  REVOKES_TRADING_AUTHORITY: 'H2A',
  RECOMMENDS_TRADE_TO: 'A2H',
  WARNS: 'A2H',
  REQUESTS_MARGIN_FROM: 'A2H',
  REPORTS_PNL_TO: 'A2H',
  ESCALATES_RISK_TO: 'A2H',
  EXPLAINS_DECISION_TO: 'A2H',
  PROPOSES_TRADE_TO: 'A2A',
  REQUESTS_RISK_REVIEW_FROM: 'A2A',
  APPROVES_EXECUTION_FOR: 'A2A',
  VETOES_EXECUTION_FOR: 'A2A',
  ROUTES_ORDER_TO: 'A2A',
  VERIFIES_FILL_FROM: 'A2A',
  RECONCILES_POSITION_FOR: 'A2A',

  // Stablecoin Intelligence actor edges
  SENT_STABLECOIN_TO: 'H2H',
  PAID_MERCHANT: 'H2H',
  SHARES_TREASURY_WITH: 'H2H',
  AUTHORIZED_STABLECOIN_SPEND: 'H2A',
  FUNDS_AGENT_WALLET: 'H2A',
  REQUESTED_STABLECOIN_PAYMENT: 'A2H',
  REPORTS_FLOW_TO: 'A2H',
  SETTLES_WITH_AGENT: 'A2A',
  ROUTES_PAYMENT_TO: 'A2A',

  // Interoperability Intelligence actor edges
  INITIATED_CROSS_CHAIN_WITH: 'H2H',
  SHARES_APPLICATION_WITH: 'H2H',
  REQUESTED_DELIVERY_FROM: 'H2A',
  AUTHORIZED_INTEROP_SPEND: 'H2A',
  RELAYED_FOR: 'A2H',
  REPORTS_DELIVERY_TO: 'A2H',
  COORDINATES_INTENT_WITH: 'A2A',
  VERIFIES_FOR: 'A2A',
};
