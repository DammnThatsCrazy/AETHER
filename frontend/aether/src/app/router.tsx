...
const RightsCenterPage = lazy(() => import('@aether-app/pages/legal/rights-center-page').then(m => ({ default: m.RightsCenterPage })));
          ...
          <RequireAuth>
            <AppShell>
              <Routes>
                ...
                <Route path="/rights" element={<PageSuspense><RightsCenterPage /></PageSuspense>} />
