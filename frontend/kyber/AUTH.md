# KYBER Authentication & Authorization

## Authentication

KYBER uses generic OIDC with Authorization Code Flow + PKCE.

### Flow
1. User clicks "Sign in with SSO"
2. KYBER generates PKCE verifier/challenge
3. Redirects to OIDC provider's `/authorize` endpoint
4. Provider returns authorization code
5. KYBER exchanges code for tokens via backend proxy
...
|------|------|---------|-----------|---------|----------|--------|-------|--------|
| `kyber_executive_operator` | All | Yes | Yes | No | View | Yes | Yes | Yes |
| `kyber_engineering_command` | All | Yes | Yes | Yes | Full | Yes | Yes | Yes |
| `kyber_specialist_operator` | All | Limited | No | No | View | No | Yes | No |
| `kyber_observer` | All | No | No | No | View | No | No | No |
