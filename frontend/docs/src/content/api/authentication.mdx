...
[Ingestion](/doc/api/ingestion) for the specific headers and 429 behavior on
the batch endpoint.

## Next steps

- [Ingestion API](/doc/api/ingestion) — the endpoint write keys are minted
  for.
- [Tenants](/doc/concepts/tenants) — how tenant scoping and plans relate to
  key permissions.
