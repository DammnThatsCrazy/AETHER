...
| `journey` | Journey stages and step structure ([Journeys](/doc/concepts/journeys)) |
...
- [Journeys](/doc/concepts/journeys) — the `journey` overlay lens in more
  depth.
- [Profiles](/doc/concepts/profiles) — the 360 view lenses project over.
