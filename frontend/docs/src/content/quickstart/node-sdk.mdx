...
import { Preview } from '../../components/Availability';
...
- [Ingestion API reference](/doc/api/ingestion) — the request/response shapes
  `AetherServerSDK` sends over the wire.
- [Webhooks](/doc/api/webhooks) — receive events *from* Aether (delivery
