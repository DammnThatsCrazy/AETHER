...
import { Available, Preview } from '../../components/Availability';
...
```html
<script src="https://cdn.olympuslabsml.com/sdk/v8/aether.min.js"></script>
```
...
off-by-default one: <Preview label="heatmaps" />, <Preview label="funnels" />,
<Preview label="featureFlags" />, and wallet tracking for each supported
chain family <Available label="web3 wallet tracking" />.
