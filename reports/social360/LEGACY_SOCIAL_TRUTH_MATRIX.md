...
5. **Two different "gold social" artifacts**: `docs/archive/legacy-architecture/data-lake-architecture/schemas/
...
source path: docs/archive/legacy-architecture/data-lake-architecture/schemas/gold_social_intelligence.py vs repositories/lake.py:611
