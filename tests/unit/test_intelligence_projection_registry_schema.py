...
``ownsCanonicalTruth is False`` for all, exactly the four 360 vertical slices
``implemented`` (outcome360 / economic360 / infrastructure360 / communication360)
with the rest ``in_flight``, consistent vocab enums, well-formed pending declarations,
...
def test_implementation_states_match_slice_program() -> None:
    # Exactly the four 360 vertical slices are implemented; everything else
