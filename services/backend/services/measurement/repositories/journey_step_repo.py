...
def _step_params(s: dict[str, Any]) -> tuple:
    ...
    return (
        ...
        json.dumps(s.get("transition_evidence") or {}, default=str),
        s.get("actor_type"),
        s.get("channel"),
        s.get("source"),
        s.get("source_class"),
        ...
        s.get("entry_method"),
        s.get("proof_level"),
        json.dumps(list(s.get("evidence_conflicts") or []), default=str),
        ...
        json.dumps(s.get("evidence_summary") or {}, default=str),
