        ...
        async with pool.acquire() as conn:
            async with conn.transaction():
                ...
                await conn.execute(
                    ...
                    json.dumps(journey.get("conversion_ids", []), default=str),
                    json.dumps(journey.get("event_ids", []), default=str),
                    json.dumps(journey.get("touchpoint_ids", []), default=str),
                    json.dumps(journey.get("session_ids", []), default=str),
                    json.dumps(journey.get("device_ids", []), default=str),
                    json.dumps(journey.get("campaign_ids", []), default=str),
                    json.dumps(journey.get("channel_sequence", []), default=str),
