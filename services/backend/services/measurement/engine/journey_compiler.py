...
def _build_steps(
    ...
    for i, activity in enumerate(activities):
        steps.append({
            ...
            "traffic_origin": activity.get("traffic_origin"),
            "economic_class": activity.get("economic_class"),
            "channel_family": activity.get("channel_family"),
            "entry_method": activity.get("entry_method"),
            "proof_level": activity.get("proof_level"),
            "evidence_conflicts": activity.get("evidence_conflicts") or [],
