...
# Task name registered by services/agents/queue/tasks.py. Dispatch is by name so
...
def _broker_url() -> str:
    ...
    what services/agents/queue/celery_app.py itself reads; REDIS_URL is the shared
