...
RELATIONSHIP_MOTIF_EVIDENCE_INDEPENDENCE_POLICIES: tuple[str, ...] = (
...
RELATIONSHIP_MOTIF_INCENTIVE_POLICIES: tuple[str, ...] = (
    "NONE_REQUIRED",
...
RELATIONSHIP_MOTIF_EDGE_ROLES: tuple[str, ...] = ("source", "target", "intermediate")

# Canonical relationship-motif catalog (JSON file order).
RELATIONSHIP_MOTIFS: tuple[dict[str, Any], ...] = (
    {
