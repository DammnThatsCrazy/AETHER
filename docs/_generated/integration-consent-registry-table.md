...
# Aether Integration Consent Registry (24 connectors/adapters, contract v8.13.0)
...
| `braze` | Braze | marketing | medium | available | marketing | consent | field_allowlist_only | braze_rest_pull |
