...
| `fraud_prevention` | Fraud Prevention | no | ✓ required | 365d | stop_new_collection | Bot detection, fraud and abuse signal analysis, and platform security monitoring. Always requires explicit opt-in. |
