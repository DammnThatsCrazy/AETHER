...
`economic360`, `infrastructure360`, `temporal360`); the rest are `in_flight`.
`implementationState` is repo metadata, **not** readiness. `infrastructure360` is
