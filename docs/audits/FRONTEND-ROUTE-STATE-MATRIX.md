...
The denominator is the 136 data-bearing route patterns above: 52 Aether and
84 Kyber routes.

| Metric | Current automated coverage | Requirement |
|---|---:|---:|
| Explicit loading-state assertions | 18 / 136 (13.2%) | tracked for every route |
| Empty-state assertions | 124 / 136 (91.2%) | at least 90% overall |
| Error/unavailable assertions | 106 / 136 (77.9%) | 100% of critical routes |
| Populated-state assertions | 34 / 136 (25.0%) | tracked for every route |
