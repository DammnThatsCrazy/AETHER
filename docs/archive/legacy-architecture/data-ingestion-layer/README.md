...
> implementation is the Python monolith at `services/backend/`
...
> The archive is intentionally retained for traceability and is not a runtime
> input. Do not add new code here.

# Aether Data Ingestion Layer v0.1.0-alpha.0
...
cd docs/archive/legacy-architecture/data-ingestion-layer
