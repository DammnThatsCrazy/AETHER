...
(Phase 4, G4.5). None of the trio was actually served live until the Phase-1
registration seam; temporal360 was not routable on the exploration surface until
its T2.3 surface + adapter shipped, population360 until its P3.5 surface +
adapter shipped, and geographic360 until its G4.4b surface + adapter shipped
(with the G4.5 surfaceIds flip + boot wiring converging the row).
