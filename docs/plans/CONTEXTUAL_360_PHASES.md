...
registration seam, population360 was not routable on the exploration surface
until its P3.5 surface + adapter shipped, and geographic360 was not routable on
the exploration surface until its G4.4b surface + adapter shipped (its row stays
`in_flight` until the G4.5 surfaceIds flip + boot wiring).
