...
## Playbook-generated recommendations

Recommendations generated by playbook evaluation carry `playbook_id` and `playbook_run_id` metadata in the persisted record. The investigation workspace continues to show evidence, confidence, decisions, actions, outcomes, governance flags, and freshness without exposing cross-tenant playbook data. See [Playbooks](./PLAYBOOKS.md).
