...
- Landed in PR 3: the planner, domain adapters, `/v1/explore/*` routes,
  ...
  the S1 projection engine, and the three 360 surfaces gained
  **projection-backed adapters** (S6 — `adapters/projection.py`, below).
