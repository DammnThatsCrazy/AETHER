...
EXISTING_BUILDER_MODULES: dict[str, str] = {
    ...
    "x402_reconciliation": "services.x402.settlement",
    "credential_expiry_sweep": "services.providers.credentials.sweeper",
    ...
    "reward_reservation_release": "services.rewards.reservation_release",
    "reward_claim_reconciliation": "services.rewards.reconcile",
    "reward_receipt_evidence": "services.rewards.receipt_evidence",
    # Authored during the integration pass: services/interop/scan_worker, lazily
    # re-exported through services/interop/lifecycle (the spec's factory source).
    "interop_scan": "services.interop.lifecycle",
}
