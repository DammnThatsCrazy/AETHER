...
SDK_VERSION_BANDS: tuple[SdkVersionBand, ...] = (
    SdkVersionBand(
        ...
        note="Current canonical SDK band (0.x pre-release). Full ingestion capability set.",
    ),
    SdkVersionBand(
        id="deprecated",
        status="deprecated",
        ...
        blocked_after=None,
        capabilities=_CAPS_FULL,
        note="Reserved for future deprecated bands.",
    ),
    SdkVersionBand(
        id="read_compatible",
        ...
        note="Reserved for future read-compatible bands.",
    ),
    SdkVersionBand(
        id="blocked",
        status="blocked",
        ...
        capabilities=_CAPS_FLAT,
        note="Reserved for future blocked bands.",
    ),
    SdkVersionBand(
        id="unsupported",
        status="unsupported",
        label="Unsupported",
        min_version=None,
        max_version_exclusive="0.1.0",
        deprecated_after=None,
        blocked_after=BLOCKED_AFTER_DATE,
        capabilities=(),
        note="<0.1.0 — outside every supported band; advisory only.",
    ),
)
