...
_CHANNEL_TOPICS: tuple[Topic, ...] = (
    ...
    Topic.SUGGESTION_DETECTED,
    Topic.SUGGESTION_ORIENTED,
    Topic.SUGGESTION_CREATED,
    Topic.SUGGESTION_REVIEW_REQUIRED,
    Topic.SUGGESTION_APPROVED,
    Topic.SUGGESTION_REJECTED,
    Topic.SUGGESTION_SUPPRESSED,
    Topic.SUGGESTION_EXECUTING,
    Topic.SUGGESTION_EXECUTED,
    Topic.SUGGESTION_DELIVERED,
    Topic.SUGGESTION_OUTCOME_RECORDED,
    Topic.SUGGESTION_CLOSED,
    Topic.SUGGESTION_FAILED,
    Topic.SUGGESTION_EXPIRED,
)
...
_CHANNEL_MAP: list[tuple[str, str]] = [
    ...
    ("suggestion", "suggestions.feed"),
    ("aether.suggestions.review", "suggestions.review"),
    ("aether.suggestions.outcome", "suggestions.outcomes"),
