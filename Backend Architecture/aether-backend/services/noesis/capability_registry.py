...
CAPABILITY_REGISTRY: list[NoesisCapability] = [
    ...
    NoesisCapability(
        ...
        label="Agent Profile 360 Lookup",
        description="Build Agent Profile 360 evidence from observed MCP, tool, grant, risk, and canonical activity facts.",
        surfaces=["aether", "kyber"],
        requires_target=True,
        example_prompts=["Build Agent Profile 360 for agent agent_123", "Show observed MCP and grant evidence for agent agent_123"],
        data_sources=["agentic_product_surfaces", "canonical_activity", "silver_agent_*_facts"],
    ),
    NoesisCapability(
        intent="journey_agentic_steps_lookup",
        label="Journey v2 Agentic Steps Lookup",
        description="List observed agentic canonical activity rows as Journey v2-compatible steps.",
        surfaces=["aether", "kyber"],
        requires_target=False,
        example_prompts=["Show Journey v2 agentic steps", "Which journey steps came from agent agent_123?"],
        data_sources=["canonical_activity", "agentic_product_surfaces"],
    ),
    NoesisCapability(
        intent="campaign_agentic_influence_lookup",
        label="Campaign Agentic Influence Lookup",
        description="Summarize campaign touchpoints influenced by observed agentic activity without claiming causality.",
        surfaces=["aether", "kyber"],
        requires_target=True,
        example_prompts=["Show agentic influence for campaign camp_123", "Which agents produced campaign touchpoints?"],
        data_sources=["canonical_activity", "agentic_product_surfaces"],
    ),
    NoesisCapability(
