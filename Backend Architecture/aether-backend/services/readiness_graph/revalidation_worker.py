...
from services.capabilities.readiness_repo import (
...
# down). Credential trouble maps to CREDENTIAL_INVALID; operational
# silence/failure maps to DEGRADED; a hard-disable maps to DISABLED.
_BLOCKER_TO_TARGET: dict[NodeStatus, CredentialReadiness] = {
    NodeStatus.CREDENTIAL_MISSING: CredentialReadiness.CREDENTIAL_INVALID,
    NodeStatus.CREDENTIAL_INVALID: CredentialReadiness.CREDENTIAL_INVALID,
...
async def build_readiness_revalidation_worker(
    *,
    ...
    store: Optional[CapabilityReadinessService] = None,
