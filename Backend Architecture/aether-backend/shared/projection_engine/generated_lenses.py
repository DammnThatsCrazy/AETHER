...
LENS_REGISTRY_CONTRACT_VERSION = "1.0.0"

# Lens kinds a lens may be.
LENS_KINDS: tuple[str, ...] = ("base", "overlay")
...
# Full lens definitions (sorted by lens id).
LENS_DEFINITIONS: dict[str, dict] = {
    "agent": {
        "id": "agent",
        "displayName": "Agent",
        "kind": "overlay",
...
__all__ = [
    ...
    "LENS_IDS",
    "LENS_KINDS",
    "LENS_REGISTRY_CONTRACT_VERSION",
]
