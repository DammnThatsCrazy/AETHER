...
import { getMockControllers } from '@kyber/fixtures/controllers';
import { getMockReviewBatches } from '@kyber/fixtures/review';
import { getMockHealthData } from '@kyber/fixtures/health';
import { getMockMissionData } from '@kyber/fixtures/mission';
import { createReplayController } from '@kyber/lib/replay';
import type { LiveEvent } from '@kyber/types';
...
function ExportPanel() {
  const handleExport = useCallback((type: string) => {
    ...
    a.href = url;
    a.download = `kyber-fixture-${type}-${new Date().toISOString().slice(0, 10)}.json`;
    a.click();
