...
import type { NeedsHelpCard, Intervention } from '@kyber/types';
...
export function getMockMissionData(): MissionData {
  return {
    throughput: {
      eventsPerSecond: 342,
      eventsPerMinute: 20_520,
      totalLast1h: 1_231_200,
      totalLast24h: 28_492_800,
      trend: 'up',
    },
    globalHealth: {
      status: 'degraded',
    ...
    commandBrief: `KYBER COMMAND BRIEF \u2014 ${now.toISOString().slice(0, 16)}Z
...
Next actions: Review pending approval batch #47 (12 mutations staged).
    ...
    keyChanges1h: [
      ...
      { id: 'kc-1h-005', description: 'Trust score drop for wallet 0x7a3b...f2e1 (0.82 \u2192 0.41)', severity: 'P2', timestamp: ago(25), controller: 'noesis', entityId: 'wallet-0x7a3b', entityType: 'wallet' },
    ],
    keyChanges24h: [
      ...
      { id: 'kc-24h-002', description: 'New suspicious cluster C-892 identified by graph analysis', severity: 'P2', timestamp: ago(240), controller: 'noesis' },
    ...
    keyChanges7d: [
      { id: 'kc-7d-001', description: 'Major graph enrichment cycle completed (2,400 entities processed)', severity: 'info', timestamp: ago(2880), controller: 'noesis' },
    ...
    recommendedActions: [
      ...
      {
        id: 'ra-004',
        title: 'Review wallet 0x7a3b neighborhood in Noesis',
