...
export const liveEventSchema = z.object({
  id: z.string(),
  type: z.enum(['analytics', 'graph-mutation', 'agent-lifecycle', 'controller', 'onboarding', 'support', 'stuck-cycle', 'anomaly', 'alert', 'system']),
  timestamp: z.string(),
...
export const controllerSchema = z.object({
  name: z.enum(['governance', 'char', 'intake', 'noesis', 'zeong', 'triage', 'verification', 'commit', 'recovery', 'chronicle', 'catalyst', 'relay']),
  health: healthStatusSchema,
  queueDepth: z.number(),
