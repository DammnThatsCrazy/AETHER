...
export type Profile360EntityType = EntityType | 'human' | 'organization' | 'journey' | 'delegation' | 'session' | 'platform' | 'browser' | 'device' | 'transaction' | 'execution_trace';
...
export interface Profile360Section {
  ...
  readonly metrics?: readonly Profile360Metric[];
  readonly references?: readonly Profile360Reference[];
  readonly data?: Record<string, unknown>;
}

export interface Profile360DrillItem extends Profile360Reference {
