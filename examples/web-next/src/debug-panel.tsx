// examples/web-next/src/debug-panel.tsx — adapted from apps/proof-web/src/debug-panel.tsx
    ...
    >
      ...
      {realConsent && (
        ...
        >
          ...
          >
            Real Consent State (from @aether/web SDK)
          </h3>
      ...
      {sdkInstance && (
        ...
        >
          SDK instance: {String(sdkInstance !== null)}
          <br />
          Methods available: init, track, observe, pageView, conversion,
          flush, reset, destroy, consent, wallet, commerce, agent, x402
        </div>
      )}
    </section>
  );
